...
public class AppConfig {
	...
	public JdbcTemplate jdbcTemplateLogin() throws Exception {
		...
		if (perfilSeleccionado.equals("local")) {
			...
			dataSource = (DataSource) new JndiTemplate().lookup("java:jboss/datasources/restauranteWeb_LoginDS");
	...
	public JdbcTemplate jdbcTemplateEjecucion() throws Exception {
		...
		if (perfilSeleccionado.equals("local")) {
			...
			dataSource = (DataSource) new JndiTemplate().lookup("java:jboss/datasources/restauranteWeb_EjecucionDS");
